...
//Returns a value from 0 to 1
...
#endif
    {
        ...
        //if(x == 13.0) - Moved inline //for the 13th channel of each sector... Go down a sector for these DMX Channel Ranges...
        {
...
#endif
        float value = (!getNineUniverseMode() || _EnableCompatibilityMode == 1)
